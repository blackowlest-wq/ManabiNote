...
const questions = createArithmeticQuestions('addition', () => 0.999)

describe('arithmetic session', () => {
  it('marks the selected answer as correct or incorrect', () => {
    const session = createArithmeticSession('addition', questions, () => new Date('2026-08-11T10:00:00.000Z'), () => 0.999)
