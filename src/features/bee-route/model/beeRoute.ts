...
export const BEE_ROUTE_STAGES: readonly BeeRouteStage[] = [
  ...
  { name: 'やまみちの おはな', hive: { row: 4, column: 0 }, flowers: [flower('a', '🌷', 3, 1), flower('b', '🌻', 1, 1), flower('c', '🌼', 0, 3), flower('d', '🌹', 2, 4), flower('e', '🪻', 4, 4)], energyBudget: 20, optimalEnergy: 16, solution: ['a', 'b', 'c', 'd', 'e', 'hive'] },
  { name: 'おはなばたけを ひとまわり', hive: { row: 0, column: 2 }, flowers: [flower('a', '🌹', 0, 0), flower('b', '🌷', 2, 0), flower('c', '🌻', 4, 1), flower('d', '🌼', 4, 3), flower('e', '🪻', 2, 4), flower('f', '🌸', 0, 4)], energyBudget: 20, optimalEnergy: 16, solution: ['a', 'b', 'c', 'd', 'e', 'f', 'hive'] },
  { name: 'ほしがた フライト', hive: { row: 2, column: 2 }, flowers: [flower('a', '🌷', 0, 2), flower('b', '🌻', 0, 4), flower('c', '🌼', 2, 4), flower('d', '🌹', 4, 4), flower('e', '🪻', 4, 0), flower('f', '🌸', 2, 0)], energyBudget: 18, optimalEnergy: 16, solution: ['a', 'b', 'c', 'd', 'e', 'f', 'hive'] },
  { name: 'そとの わを ぐるり', hive: { row: 4, column: 2 }, flowers: [flower('a', '🌷', 4, 0), flower('b', '🌻', 2, 0), flower('c', '🌼', 0, 0), flower('d', '🌹', 0, 2), flower('e', '🪻', 0, 4), flower('f', '🌸', 2, 4), flower('g', '🏵️', 4, 4)], energyBudget: 18, optimalEnergy: 16, solution: ['a', 'b', 'c', 'd', 'e', 'f', 'g', 'hive'] },
  { name: 'はちのじ おはなめぐり', hive: { row: 2, column: 2 }, flowers: [flower('a', '🌷', 1, 2), flower('b', '🌻', 0, 2), flower('c', '🌼', 0, 4), flower('d', '🌹', 2, 4), flower('e', '🪻', 4, 4), flower('f', '🌸', 4, 2), flower('g', '🏵️', 4, 0), flower('h', '💐', 2, 0)], energyBudget: 18, optimalEnergy: 16, solution: ['a', 'b', 'c', 'd', 'e', 'f', 'g', 'h', 'hive'] },
  { name: 'ひみつの おはなリング', hive: { row: 2, column: 2 }, flowers: [flower('a', '🌷', 2, 1), flower('b', '🌻', 1, 1), flower('c', '🌼', 1, 2), flower('d', '🌹', 1, 3), flower('e', '🪻', 2, 3), flower('f', '🌸', 3, 3), flower('g', '🏵️', 3, 2), flower('h', '💐', 3, 1)], energyBudget: 12, optimalEnergy: 10, solution: ['a', 'b', 'c', 'd', 'e', 'f', 'g', 'h', 'hive'] },
]
