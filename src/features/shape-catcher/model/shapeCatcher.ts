...
export const SHAPE_CATCHER_STAGES: readonly ShapeCatcherStage[] = [
  ...
  { name: 'ぼうと かど', pieces: [{ kind: 'bar', rotation: 1 }, { kind: 'corner', rotation: 1 }, { kind: 'bar', rotation: 0 }, { kind: 'corner', rotation: 3 }, { kind: 'bar', rotation: 1 }, { kind: 'corner', rotation: 2 }], dropTicks: 4, intervalMs: 680 },
  { name: 'Tがた ラッシュ', pieces: [{ kind: 'tee', rotation: 0 }, { kind: 'tee', rotation: 2 }, { kind: 'tee', rotation: 1 }, { kind: 'tee', rotation: 3 }, { kind: 'tee', rotation: 0 }, { kind: 'tee', rotation: 1 }], dropTicks: 4, intervalMs: 660 },
  { name: 'みぎへ ひだりへ', pieces: [{ kind: 'corner', rotation: 1 }, { kind: 'tee', rotation: 3 }, { kind: 'corner', rotation: 3 }, { kind: 'bar', rotation: 1 }, { kind: 'tee', rotation: 1 }, { kind: 'corner', rotation: 0 }, { kind: 'bar', rotation: 0 }], dropTicks: 3, intervalMs: 640 },
  { name: 'かたちの あめ', pieces: [{ kind: 'bar', rotation: 0 }, { kind: 'corner', rotation: 2 }, { kind: 'tee', rotation: 3 }, { kind: 'corner', rotation: 1 }, { kind: 'bar', rotation: 1 }, { kind: 'tee', rotation: 0 }, { kind: 'corner', rotation: 3 }], dropTicks: 3, intervalMs: 610 },
  { name: 'くるくる こうじょう', pieces: [{ kind: 'tee', rotation: 2 }, { kind: 'bar', rotation: 1 }, { kind: 'corner', rotation: 0 }, { kind: 'tee', rotation: 1 }, { kind: 'corner', rotation: 2 }, { kind: 'bar', rotation: 0 }, { kind: 'tee', rotation: 3 }, { kind: 'corner', rotation: 1 }], dropTicks: 3, intervalMs: 580 },
  { name: 'スピード キャッチ', pieces: [{ kind: 'corner', rotation: 3 }, { kind: 'bar', rotation: 1 }, { kind: 'tee', rotation: 0 }, { kind: 'bar', rotation: 0 }, { kind: 'corner', rotation: 1 }, { kind: 'tee', rotation: 2 }, { kind: 'corner', rotation: 0 }, { kind: 'tee', rotation: 3 }], dropTicks: 3, intervalMs: 550 },
  { name: 'レインボー キャッチ', pieces: [{ kind: 'bar', rotation: 1 }, { kind: 'tee', rotation: 1 }, { kind: 'corner', rotation: 2 }, { kind: 'tee', rotation: 3 }, { kind: 'corner', rotation: 0 }, { kind: 'bar', rotation: 0 }, { kind: 'corner', rotation: 1 }, { kind: 'tee', rotation: 2 }, { kind: 'bar', rotation: 1 }], dropTicks: 2, intervalMs: 520 },
  { name: 'かたち チャンピオン', pieces: [{ kind: 'tee', rotation: 3 }, { kind: 'corner', rotation: 1 }, { kind: 'bar', rotation: 0 }, { kind: 'corner', rotation: 3 }, { kind: 'tee', rotation: 0 }, { kind: 'bar', rotation: 1 }, { kind: 'tee', rotation: 2 }, { kind: 'corner', rotation: 2 }, { kind: 'bar', rotation: 0 }], dropTicks: 2, intervalMs: 480 },
]
