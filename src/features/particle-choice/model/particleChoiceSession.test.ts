...
const questions = createParticleChoiceQuestions('normal', () => 0.999)

describe('particle choice session', () => {
  it('marks the matching particle as correct', () => {
    const session = createParticleChoiceSession('normal', questions, () => new Date('2026-08-11T10:00:00.000Z'), () => 0.999)
